...
Nova.booting(function (Vue) {
    Vue.component('nova-excel-import', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        processImport: function processImport() {
            ...
            Nova.request().post('/nova-vendor/willis1776/nova-excel-import/endpoint/' + this.card.resource, formData).then(function (_ref) {
                var data = _ref.data;
  ...
  return _c("card", { staticClass: "flex flex-col h-auto" }, [
    _c("div", { staticClass: "px-3 py-3" }, [
      _c("h1", { staticClass: "text-xl font-light" }, [
        _vm._v(_vm._s(_vm.__("Import")) + " " + _vm._s(this.card.resourceLabel))
      ]),
      _vm._v(" "),
      _c(
        "form",
        {
          ...
          on: {
            submit: function($event) {
              ...
              return _vm.processImport.apply(null, arguments)
            }
          }
        },
        [
          ...
          _c(
            "div",
            { staticClass: "py-4", class: { flex: _vm.card.inline } },
            [
              _c(
                "label",
                {
                  staticClass: "block mb-3 mr-3 text-80 pt-2 leading-tight",
                  attrs: { for: _vm.date }
                },
                [_vm._v("Date")]
              ),
              ...
              _c("date-time-picker", {
                ...
                on: {
                  ...
                  change: function($event) {
                    return _vm.handleChange(_vm.date, $event)
                  }
                },
                model: {
                  value: _vm.date,
